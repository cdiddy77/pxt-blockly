...
Blockly.BlockSvg.prototype.initSvg = function () {
  ...
  if (!this.workspace.options.readOnly && !this.eventsInit_) {
    ...
    Blockly.bindEventWithChecks_(this.getSvgRoot(), 'dblclick', this, this.onDoubleClick_);
  }
...
/**
 * Handle a double-click on an SVG block
 * @param {!Event} e doubleclick event.
 * @private
 */
Blockly.BlockSvg.prototype.onDoubleClick_ = function (e) {
  if (this.workspace.options.readonly) {
    return;
  }
  console.log('we got the doubleclick, why it not working?');
  if (this.collapsed_) {
